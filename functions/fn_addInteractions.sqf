...
["FirePlace_burning_F",0,["ACE_MainActions"],_action] call ace_interact_menu_fnc_addActionToClass;
["Campfire_burning_F",0,["ACE_MainActions"],_action] call ace_interact_menu_fnc_addActionToClass;
